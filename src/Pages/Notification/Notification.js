...
export default function Notification() {
  ...
  return (
    <div
      className={`h-full w-full pb-[15px] pt-2 ${dark === false ? 'text-black' : 'text-white'}`}
    >
            ...
            {[...Array(20)].map((_, index) => (
              <tr key={index} className="border-b-2 border-[#c53142] font-['Nunito'] text-[15px] font-normal">
                ...
                <td className="px-6 py-5">
                  <span className="px-[45px] py-3 rounded-[20px] bg-[#C53142] text-white font-semibold">Complete</span>
                </td>
              </tr>
            ))}
          </tbody>
